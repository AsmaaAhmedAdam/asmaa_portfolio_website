...
<section class="main-content text-center revealator-slideup revealator-once revealator-delay1">
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="slideshow">
            ...
            <nav>
                <span class="icon nav-prev"><img src="{{url('public/img/projects/navigation/left-arrow.png')}}" alt="previous"></span>
                <span class="icon nav-next"><img src="{{url('public/img/projects/navigation/right-arrow.png')}}" alt="next"></span>
                <span class="nav-close"><img src="{{url('public/img/projects/navigation/close-button.png')}}" alt="close"> </span>
            </nav>
